...
import { Props } from './LineChartComponent.interface'


const LineChartComponent:React.FC<Props> = ({fetchDataThunk,xAxisData,yAxisData,loading}) => {
      ...
      {dataSet.length ? (
        <>
          <ResponsiveContainer height={600}>
            <LineChart  margin={{ top: 10, right: 30, left: 0, bottom: 0 }} width={720} height={400} data={dataSet}>
              <defs>
              ...
              <Line type={"monotone"} dataKey="RandomNumber1" stroke='#2563eb' fill='#3b82f6' />
              <Line type={"monotone"} dataKey="RandomNumber2" stroke='#7c3aed' fill='#8b5cf6' />
              <Tooltip />
              <Legend/>
