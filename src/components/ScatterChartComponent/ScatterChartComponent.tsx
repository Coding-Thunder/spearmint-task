...
import { Scatter, ScatterChart, CartesianGrid, ResponsiveContainer, Tooltip, XAxis, YAxis, Legend } from 'recharts'
import Spinner from '../Spinner/Spinner'
import { fetchData } from '../../redux/data/data.action'
import { connect } from 'react-redux'
import { Props } from './ScatterChartComponent.interface'




const ScatterChartComponent:React.FC<Props> = ({fetchDataThunk,xAxisData,yAxisData,loading}) => {
      ...
      {dataSet.length ? (
        <>
          <ResponsiveContainer height={600}>
            <ScatterChart  margin={{ top: 10, right: 30, left: 0, bottom: 0 }} width={720} height={400} data={dataSet}>
              <defs>
              ...
              <Scatter type={"monotone"} dataKey="RandomNumber1" stroke='#2563eb' fill='#3b82f6' />
              <Scatter type={"monotone"} dataKey="RandomNumber2" stroke='#7c3aed' fill='#8b5cf6' />
              <Tooltip />
              <Legend/>
...
export default connect(mapStateToProps,mapDispatchToProps)(ScatterChartComponent)
